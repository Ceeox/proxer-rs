...
impl<'a> Anime<'a> {
    #[doc(hidden)]
    pub fn new(proxer: &'a Proxer) -> Anime<'a> {
        Anime { proxer: proxer }
    }
    ...
    pub fn get_streams(&self, id: u64, episode: u64, language: Language) -> Result<Vec<Stream>> {
    ...
    ///
    /// * `id` - Die id des Entrys
    pub fn get_link(&self, id: u64) -> Result<String> {
